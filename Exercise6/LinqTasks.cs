...
namespace Exercise6
{
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            var result = emps
                .Where(emp => emps.Any(e => e.Mgr == emp)) // Sprawdzamy, czy istnieje inny pracownik, którego menedżerem jest ten pracownik
                .OrderBy(emp => emp.Ename) // Sortujemy po nazwisku (rosnąco)
                .ThenByDescending(emp => emp.Salary); // Następnie po pensji (malejąco)
            return result;
        }
    }
}